...
class Queue:
    ...
    def enqueue(self, elem: Any) -> None:
        ...
        self._items.append(elem)  # TODO реализовать метод enqueue
    ...
    def clear(self) -> None:
        """ Очистка очереди. """
        self._items.clear()  # TODO реализовать метод clear

    def __len__(self):
        """ Количество элементов в очереди. """
        return len(self._items)  # TODO реализовать метод __len__
